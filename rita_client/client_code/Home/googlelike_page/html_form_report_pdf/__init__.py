from ._anvil_designer import html_form_report_pdfTemplate
from anvil import *
import anvil.server
...
class html_form_report_pdf(html_form_report_pdfTemplate):
  def __init__(self,input_dic=[],lastPage=None,**properties):
  ...
  def printScreen(self, **event_args):
    anvil.js.call('printScreen')
  ...
  def back_button_click(self, **event_args):
    # form = self.last_page(critical_objects_found_dic=self.input_dic)
    # self.last_page.remove_from_parent()
    # open_form(self.last_page)
    self.set_open_form(self.last_page)
