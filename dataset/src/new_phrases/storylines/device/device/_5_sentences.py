...
sentences = {
    ...
    "Bosch Connected Control Smart Thermostat": [
        "Thanks to the Bosch Connected Control Smart Thermostat's easy-to-use app, John was able to remotely control the temperature of his home while he was away.",
        "Using the Bosch Connected Control Smart Thermostat's smart scheduling feature, Sarah was able to optimize the temperature settings according to her daily routine, saving energy and money.",
        "The Bosch Connected Control Smart Thermostat's built-in motion sensor made it easy for Michael to automatically adjust the temperature when he entered or left a room.",
        "By using the Bosch Connected Control Smart Thermostat's advanced weather forecasting algorithms, Emily was able to optimize the temperature settings based on the local weather conditions.",
        "The Bosch Connected Control Smart Thermostat's sleek design and intuitive user interface made it easy for James to control the temperature of his home, even when he had guests over.",
    ],
    "Lux Geo Smart Thermostat": [
        "The Lux Geo Smart Thermostat's geofencing feature allowed Mary to automatically adjust the temperature of her home based on her location, making it comfortable and cozy whenever she arrived.",
        "Using the Lux Geo Smart Thermostat's advanced learning algorithms, Andrew was able to optimize the temperature settings based on his daily routine, saving up to 23% on his energy bill.",
        "The Lux Geo Smart Thermostat's intuitive touchscreen interface made it easy for Sarah to adjust the temperature settings and view her energy consumption at a glance.",
        "Thanks to the Lux Geo Smart Thermostat's compatibility with Amazon Alexa, Peter was able to control the temperature of his home using just his voice, without having to lift a finger.",
        "The Lux Geo Smart Thermostat's sleek and compact design made it easy for Mark to install it in any room of his home, without taking up too much space.",
    ],
    "Amazon Echo (4th Gen)": [
        "Thanks to the Amazon Echo (4th Gen)'s built-in Zigbee hub, Rachel was able to easily control all her smart devices from a single interface.",
        "Using the Amazon Echo (4th Gen)'s advanced voice recognition technology, David was able to control his home's lighting, music, and temperature using just his voice.",
        "The Amazon Echo (4th Gen)'s powerful speakers and advanced audio features made it easy for Michael to stream his favorite songs and podcasts in high quality.",
        "Thanks to the Amazon Echo (4th Gen)'s compatibility with thousands of smart home devices, Sarah was able to easily integrate it with her existing smart home ecosystem.",
        "The Amazon Echo (4th Gen)'s sleek and modern design added a touch of elegance to Jennifer's living room, while also being practical and functional.",
    ],
    "Google Nest Audio": [
        "Thanks to the Google Nest Audio's powerful speakers and advanced audio processing algorithms, Emily was able to enjoy her favorite music and podcasts in high quality.",
        "Using the Google Nest Audio's built-in Google Assistant, Peter was able to control the temperature of his home, set reminders, and ask for directions using just his voice.",
        "The Google Nest Audio's compatibility with Chromecast and other smart home devices made it easy for Sarah to create a seamless smart home experience.",
        "Thanks to the Google Nest Audio's advanced voice recognition technology, John was able to use it even from across the room, without having to get up from his couch.",
        "The Google Nest Audio's minimalist design and soft-touch finish made it easy for Laura to blend it into her home decor, while also being practical and functional.",
    ],
    "HomePod Mini": [
        "Samantha asked Siri on her HomePod Mini to play her favorite song, and the room was filled with her favorite tunes.",
        "David was able to control his smart home devices with ease using his HomePod Mini's built-in HomeKit functionality.",
    ...
    "Harman Kardon Citation 300": [
        ...
        "Thanks to the Harman Kardon Citation 300's Wi-Fi connectivity, Mark was able to easily stream music from his favorite services, such as Spotify and Tidal.",
        "Alice used her Harman Kardon Citation 300 to play white noise at night, helping her get a better night's sleep.",
        "The Harman Kardon Citation 300's sleek, modern design and premium materials made it a perfect addition to Jane's stylish living room.",
    ],
    "Bose Home Speaker 500": [
        "Jason was impressed by the Bose Home Speaker 500's powerful, room-filling sound that easily filled his entire home.",
        "Thanks to the Bose Home Speaker 500 Music app, Emily was able to easily control her home audio system and stream music from a variety of services.",
        "With the Bose Home Speaker 500's built-in Alexa functionality, David was able to use voice commands to control his smart home devices.",
    ...
    "Sylvania Smart+ A19 Full Color LED Bulb": [
        ...
        "With the Sylvania Smart+ A19 Full Color LED Bulb, Maria was able to schedule her lights to turn on and off at specific times to make it look like she was home when she wasn't.",
        "Bob saved money on his electricity bill with the Sylvania Smart+ A19 Full Color LED Bulb's energy-saving features.",
        "The Sylvania Smart+ A19 Full Color LED Bulb's dimming capabilities allowed Tom to adjust the lighting in his home to his preferred level.",
    ],
    "C by GE Full Color Direct Connect LED Smart Bulbs": [
        "With the C by GE Full Color Direct Connect LED Smart Bulbs, Emily was able to adjust the lighting in her home to match her mood or activity.",
        "The C by GE Full Color Direct Connect LED Smart Bulbs allowed John to set up schedules for his lights so they would turn on and off automatically when he was away from home.",
        "With C by GE Full Color Direct Connect LED Smart Bulbs, Sarah was able to create a custom color palette for her home to match her personal style.",
        "Mike was able to control his C by GE Full Color Direct Connect LED Smart Bulbs with his voice, thanks to their compatibility with his smart speaker.",
        "The C by GE Full Color Direct Connect LED Smart Bulbs' energy-saving features helped Mary lower her electricity bill.",
    ],
    "Lutron Caseta Wireless Smart Lighting Dimmer Switch": [
        "The Lutron Caseta Wireless Smart Lighting Dimmer Switch allowed David to control the lights in his home with his smartphone.",
        "With the Lutron Caseta Wireless Smart Lighting Dimmer Switch, Jennifer was able to set up custom lighting scenes for different activities, like reading or watching TV.",
        "The Lutron Caseta Wireless Smart Lighting Dimmer Switch's compatibility with smart assistants allowed Mike to control his lights with his voice.",
        "Jessica saved energy and money on her electricity bill with the Lutron Caseta Wireless Smart Lighting Dimmer Switch's energy-saving features.",
        "With the Lutron Caseta Wireless Smart Lighting Dimmer Switch, Brian was able to remotely control the lights in his home from anywhere using his smartphone.",
    ],
    "TP-Link Kasa Smart Wi-Fi Light Bulb": [
        "The TP-Link Kasa Smart Wi-Fi Light Bulb allowed Jane to control the lights in her home with her voice using her smart speaker.",
        "With the TP-Link Kasa Smart Wi-Fi Light Bulb, Chris was able to set up schedules for his lights to turn on and off automatically, even when he wasn't home.",
        "The TP-Link Kasa Smart Wi-Fi Light Bulb's compatibility with popular smart assistants made it easy for Sarah to control her lights with her voice.",
        "Tom saved money on his electricity bill with the TP-Link Kasa Smart Wi-Fi Light Bulb's energy-saving features.",
        "With the TP-Link Kasa Smart Wi-Fi Light Bulb, Eric was able to adjust the brightness of his lights to his preferred level using his smartphone.",
    ],
    ...
    "Gate Labs All-in-One Smart Lock": [
        "Tom never had to worry about forgetting his keys again, thanks to his Gate Labs All-in-One Smart Lock which can be unlocked with his smartphone.",
        "The Gate Labs All-in-One Smart Lock made it easy for Jessica to grant access to her houseguests without having to make extra copies of her keys.",
        "With the Gate Labs All-in-One Smart Lock, Mark was able to keep track of who entered and left his house, thanks to the lock's activity log feature.",
        "The Gate Labs All-in-One Smart Lock gave Emily peace of mind knowing that her home was secure, even when she was away on vacation.",
        "John was able to easily install the Gate Labs All-in-One Smart Lock himself without needing to hire a locksmith.",
    ],
    "Igloohome Smart Deadbolt 2S": [
        "Jenny never had to worry about getting locked out of her apartment again, thanks to her Igloohome Smart Deadbolt 2S which can be unlocked with a pin code.",
        "The Igloohome Smart Deadbolt 2S allowed David to grant access to his Airbnb guests without having to physically meet them to hand over keys.",
        "With the Igloohome Smart Deadbolt 2S, Lisa was able to track who accessed her home and at what time, thanks to the lock's activity log feature.",
        "The Igloohome Smart Deadbolt 2S gave Sam peace of mind knowing that his home was secure, even when he was away on business trips.",
        "Sarah was able to easily set up the Igloohome Smart Deadbolt 2S in just a few minutes with the help of the app's step-by-step instructions.",
    ],
    "Philips Hue A19 Starter Kit": [
        "With the Philips Hue A19 Starter Kit, Mike was able to control the lighting in his home with just his voice using Alexa.",
        "The Philips Hue A19 Starter Kit allowed Rachel to set different lighting scenes for different moods, from relaxing to energizing.",
        "With the Philips Hue A19 Starter Kit, Tim was able to automate his lights to turn on and off at specific times of the day, even when he was away from home.",
        "The Philips Hue A19 Starter Kit allowed Karen to choose from a range of colors to set the perfect ambiance for her dinner parties.",
        "Joe was able to easily set up the Philips Hue A19 Starter Kit himself without needing any professional help.",
    ],
    "LIFX A60 Smart Bulb": [
        "With the LIFX A60 Smart Bulb, Alex was able to control the lighting in his home from anywhere using his smartphone.",
        "The LIFX A60 Smart Bulb allowed Mary to set her lights to gradually turn on in the morning, helping her wake up more naturally.",
        "With the LIFX A60 Smart Bulb, Tom was able to choose from millions of colors to set the perfect mood for his movie nights.",
        "The LIFX A60 Smart Bulb allowed Sarah to save energy by setting the lights to turn off automatically when she left the room.",
        "With the LIFX A60 Smart Bulb, Adam was able to sync his lights to his music, creating a fun and immersive party experience.",
    ],
    ...
    "Google Nest Cam IQ Outdoor": [
        ...
        "When the Google Nest Cam IQ Outdoor detected motion, it sent an alert to Sarah's phone and even highlighted the specific area of movement on the app.",
        ...
        "Linda was able to see who was at her front door using the Google Nest Cam IQ Outdoor's facial recognition feature, which alerted her when it recognized a familiar face.",
    ...
    "Samsung Family Hub Refrigerator": [
        "Mary checked the Samsung Family Hub Refrigerator's interior camera while shopping to see if she needed to buy more milk.",
        "Thanks to the Samsung Family Hub Refrigerator's built-in touchscreen, John was able to browse recipes and create a shopping list.",
        "Alex asked Bixby, the voice assistant on his Samsung Family Hub Refrigerator, to add bananas to his grocery list.",
        "The Samsung Family Hub Refrigerator's FlexZone drawer allowed Sarah to store her groceries at the perfect temperature for maximum freshness.",
        "Tom received a notification from his Samsung Family Hub Refrigerator when he was low on eggs, so he picked some up on his way home from work.",
    ],
    "LG Smart ThinQ Dishwasher": [
        "Thanks to the LG ThinQ app, Sarah was able to start the LG Smart ThinQ Dishwasher from her phone while at work.",
        "The LG Smart ThinQ Dishwasher's Smart Diagnosis feature alerted John when there was an issue and suggested a solution.",
        "Alex asked his voice assistant to start the LG Smart ThinQ dishwasher after dinner.",
        "The LG Smart ThinQ Dishwasher's TrueSteam technology left Mary's dishes spotless and free of any residue.",
        "Tom appreciated the LG Smart ThinQ Dishwasher's Energy Star rating, which helped lower his utility bill.",
    ],
    "GE Profile Smart Front Load Washer": [
        "Thanks to the GE Profile Smart Front Load Washer's Wi-Fi connectivity, Sarah was able to start a load of laundry while running errands.",
        "The GE Profile Smart Front Load Washer's Smart Dispense technology automatically added the perfect amount of detergent for each load.",
        "Alex received a notification when his laundry was done, thanks to the GE Profile Smart Front Load Washer's app.",
        "The GE Profile Smart Front Load Washer's built-in water faucet allowed Mary to pre-treat stains before starting the cycle.",
        "Tom appreciated the GE Profile Smart Front Load Washer's large capacity, which allowed him to wash his king-size comforter with ease.",
    ],
    "Ninja Foodi Smart XL 6-in-1 Indoor Grill": [
        "Thanks to the Ninja Foodi Smart XL 6-in-1 Indoor Grill's Smart Cook System, John was able to achieve perfectly cooked steaks every time.",
        "The Ninja Foodi Smart XL 6-in-1 Indoor Grill's Smart Thermometer continuously monitored the temperature of Mary's chicken breasts to ensure they were fully cooked.",
        "Alex was able to use the Ninja Foodi Smart XL 6-in-1 Indoor Grill's Smart Finish feature to keep his food warm until his guests arrived.",
        "The Ninja Foodi Smart XL 6-in-1 Indoor Grill's integrated Smart Probe allowed Sarah to monitor the internal temperature of her roast without opening the lid.",
        "Tom loved the Ninja Foodi Smart XL 6-in-1 Indoor Grill's ability to switch from grilling to air frying with ease, making it a versatile kitchen appliance.",
    ],
    "Samsung Refrigerator": [
        "Mary checked the Samsung Refrigerator's interior camera while shopping to see if she needed to buy more milk.",
        "Thanks to the Samsung Refrigerator's built-in touchscreen, John was able to browse recipes and create a shopping list.",
        "Alex asked Bixby, the voice assistant on his Samsung Refrigerator, to add bananas to his grocery list.",
        "The Samsung Refrigerator allowed Sarah to store her groceries at the perfect temperature for maximum freshness.",
        "Tom received a notification from his Samsung Refrigerator when he was low on eggs, so he picked some up on his way home from work.",
    ],
    "LG Smart Dishwasher": [
        "Thanks to the LG Smart Dishwasher's app, Sarah was able to start the dishwasher from her phone while at work.",
        "The LG Smart Dishwasher's Smart Diagnosis feature alerted John when there was an issue and suggested a solution.",
        "Alex asked his voice assistant to start the LG Smart Dishwasher after dinner.",
        "The LG Smart Dishwasher's TrueSteam technology left Mary's dishes spotless and free of any residue.",
        "Tom appreciated the LG Smart Dishwasher's Energy Star rating, which helped lower his utility bill.",
    ],
    "Smart Load Washer": [
        "Thanks to the Smart Load Washer's Wi-Fi connectivity, Sarah was able to start a load of laundry while running errands.",
        "The Smart Load Washer's Smart Dispense technology automatically added the perfect amount of detergent for each load.",
        "Alex received a notification when his laundry was done, thanks to the Smart Load Washer's app.",
        "The Smart Load Washer's built-in water faucet allowed Mary to pre-treat stains before starting the cycle.",
        "Tom appreciated the Smart Load Washer's large capacity, which allowed him to wash his king-size comforter with ease.",
    ],
    "Smart Indoor Grill": [
        "Thanks to the Smart Indoor Grill's Smart Cook System, John was able to achieve perfectly cooked steaks every time.",
        "The Smart Indoor Grill's Smart Thermometer continuously monitored the temperature of Mary's chicken breasts to ensure they were fully cooked.",
        "Alex was able to use the Smart Indoor Grill's Smart Finish feature to keep his food warm until his guests arrived.",
        "The Smart Indoor Grill's integrated Smart Probe allowed Sarah to monitor the internal temperature of her roast without opening the lid.",
        "Tom loved the Smart Indoor Grill's ability to switch from grilling to air frying with ease, making it a versatile kitchen appliance.",
    ],
    "LG Smart InstaView Door-in-Door Refrigerator": [
        "Karen checked the contents of her fridge from the grocery store thanks to her LG Smart InstaView Door-in-Door Refrigerator's built-in camera and Wi-Fi connectivity.",
        "John received a notification on his phone when he was running low on milk, thanks to his LG Smart InstaView Door-in-Door Refrigerator's ability to track food inventory.",
    ],
    "Breville Joule Sous Vide": [
        "Tom cooked the perfect steak with his Breville Joule Sous Vide, which he controlled with his smartphone.",
        "Emily used her Breville Joule Sous Vide to make a delicious vegetable dish with perfectly cooked carrots and zucchini.",
    ],
    "Rachio 3 Smart Sprinkler Controller": [
        "The Rachio 3 Smart Sprinkler Controller automatically adjusted the watering schedule based on the local weather, saving Sarah money on her water bill.",
        "Jason set up his Rachio 3 Smart Sprinkler Controller to water his garden only in the early morning, minimizing water loss due to evaporation.",
    ],
    "Orbit B-hyve Smart Hose Faucet Timer": [
        "The Orbit B-hyve Smart Hose Faucet Timer saved David time and money by automatically turning off the hose when his garden was fully watered.",
        "Sophie was able to control her Orbit B-hyve Smart Hose Faucet Timer from her smartphone, even when she was away from home.",
    ],
    ...
    "bObsweep PetHair Plus Robotic Vacuum Cleaner": [
        "Maggie's pet dog sheds a lot of hair, but bObsweep PetHair Plus Robotic Vacuum Cleaner does an excellent job of keeping her home clean.",
        "John never realized how much time he could save until he bought the bObsweep PetHair Plus Robotic Vacuum Cleaner, which could clean up his entire home while he was at work.",
    ],
    "Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner": [
        "Samantha loved how the Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner could clean her hardwood floors and carpets with equal efficiency.",
        "Max was able to clean up his home's messes quickly and efficiently with the Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner.",
    ],
    "HiMirror Smart Vanity Mirror": [
        "Katie could customize her makeup routine with the HiMirror Smart Vanity Mirror, which provided personalized beauty tips based on her skin condition.",
        "Sophie found the HiMirror Smart Vanity Mirror's LED lights perfect for applying makeup.",
    ],
    "Simplehuman Sensor Mirror Hi-Fi": [
        "Jack enjoyed listening to music while getting ready in the morning with the Simplehuman Sensor Mirror Hi-Fi.",
        "Emily appreciated the Simplehuman Sensor Mirror Hi-Fi's tru-lux light system, which simulated natural sunlight for a flawless makeup application.",
    ],
    "bObsweep PetHair Plus Robotic Vacuum Cleaner": [
        "Max loved how his bObsweep PetHair Plus Robotic Vacuum Cleaner effortlessly picked up pet hair from every corner of his home.",
        "With the bObsweep PetHair Plus Robotic Vacuum Cleaner, cleaning up after her pets was no longer a chore for Sarah.",
        "The bObsweep PetHair Plus Robotic Vacuum Cleaner's advanced sensors prevented it from bumping into furniture, making it a great addition to any home.",
        "Jason was impressed by the bObsweep PetHair Plus Robotic Vacuum Cleaner's long battery life and powerful suction, making cleaning up a breeze.",
        "Thanks to its sleek design, the bObsweep PetHair Plus Robotic Vacuum Cleaner seamlessly blended in with Hannah's home decor.",
    ],
    " Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner": [
        "The Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner made cleaning up spills a breeze for Emily.",
        "Derek loved how versatile the Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner was, being able to easily switch between wet and dry cleaning modes.",
        "Thanks to its cordless design, the Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner provided unparalleled flexibility when cleaning.",
        "The Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner's powerful suction easily picked up dirt and debris from every corner of Ryan's home.",
        "Megan was impressed by the Tineco iFLOOR3 Cordless Wet Dry Vacuum Cleaner's large water tank capacity, allowing her to clean large areas without constantly refilling it.",
    ],
    "HiMirror Smart Vanity Mirror": [
        "With the HiMirror Smart Vanity Mirror, Lisa was able to get personalized skincare analysis and tips.",
        "The HiMirror Smart Vanity Mirror's built-in light allowed Julia to apply her makeup with ease, even in poorly-lit areas.",
        "Thanks to its voice-activated control, the HiMirror Smart Vanity Mirror allowed Rachel to easily control it while getting ready for her day.",
        "The HiMirror Smart Vanity Mirror's 360-degree swivel feature made it easy for Lauren to get the perfect angle while doing her hair.",
        "With its sleek and modern design, the HiMirror Smart Vanity Mirror was the perfect addition to Samantha's bathroom.",
    ],
    "Simplehuman Sensor Mirror Hi-Fi": [
        "Thanks to its built-in speaker, the Simplehuman Sensor Mirror Hi-Fi allowed Michael to listen to his favorite music while getting ready.",
        "The Simplehuman Sensor Mirror Hi-Fi's automatic sensor turned on its light as soon as Emily approached it.",
        "The Simplehuman Sensor Mirror Hi-Fi's rechargeable battery made it easy for Tom to use it anywhere, without needing an outlet.",
        "Megan was impressed by the Simplehuman Sensor Mirror Hi-Fi's adjustable brightness settings, allowing her to get the perfect lighting while getting ready.",
        "Thanks to its distortion-free mirror, the Simplehuman Sensor Mirror Hi-Fi provided Katie with a crystal-clear reflection every time.",
    ],
    ...
    "Magniflex Magni Smartech Smart Bed": [
        "After using the Magniflex Magni Smartech Smart Bed, Samantha woke up feeling more rested than she ever had before.",
        "David was amazed by the Magniflex Magni Smartech Smart Bed's ability to adjust to his sleep position throughout the night.",
        "The Magniflex Magni Smartech Smart Bed's intuitive sensors provided Lisa with a personalized sleep report every morning.",
        "Kevin enjoyed the Magniflex Magni Smartech Smart Bed's massage feature, which helped him fall asleep faster and sleep deeper.",
        "The Magniflex Magni Smartech Smart Bed's temperature control feature kept Michael comfortable throughout the night, ensuring a good night's sleep.",
    ],
    "Hypnos Balmoral Smart Bed": [
        "The Hypnos Balmoral Smart Bed's sleep tracking feature helped Emily better understand her sleep patterns.",
        "Jacob found that the Hypnos Balmoral Smart Bed's adjustable base helped alleviate his back pain.",
        "The Hypnos Balmoral Smart Bed's smart alarm gently wakes up Anna, allowing her to start her day feeling refreshed.",
        "After a week of using the Hypnos Balmoral Smart Bed, Brian noticed a significant improvement in his overall sleep quality.",
        "The Hypnos Balmoral Smart Bed's app-controlled features made it easy for Sarah to customize her sleeping experience.",
    ],
    "Fitbit Aria Air Smart Scale": [
        "The Fitbit Aria Air Smart Scale's seamless integration with the Fitbit app allowed Jack to track his weight loss progress over time.",
        "Sofia appreciated the Fitbit Aria Air Smart Scale's ability to recognize multiple users and sync their data to individual accounts.",
        "The Fitbit Aria Air Smart Scale's sleek design seamlessly blended into John's bathroom decor.",
        "After using the Fitbit Aria Air Smart Scale for a few weeks, Karen was motivated to make healthier lifestyle choices.",
        "The Fitbit Aria Air Smart Scale's body composition analysis feature helped Michael better understand his overall health.",
    ],
    "Withings Body+ Smart Scale": [
        "The Withings Body+ Smart Scale's automatic user recognition feature made it easy for Michelle to keep track of her weight loss progress.",
        "Ben was impressed with the Withings Body+ Smart Scale's ability to sync his weight data to multiple fitness apps.",
        "The Withings Body+ Smart Scale's pregnancy mode feature helped Emily track her weight gain throughout her pregnancy.",
        "The Withings Body+ Smart Scale's weather display feature allowed Rachel to plan her outfit for the day while checking her weight.",
        "The Withings Body+ Smart Scale's nutrition tracking feature helped Peter monitor his daily food intake and make healthier choices.",
    ],
    "eufy Smart Scale C1": [
    ...
    "Tanita BC554 Ironman Body Composition Monitor": [
        ...
        "After trying several other body composition monitors, Jesse was impressed by the Tanita BC554 Ironman Body Composition Monitor's precision and reliability.",
    ],
    ...
    "Lock8 Smart Bike Lock": [
        "As soon as Jack's Lock8 Smart Bike Lock was tampered with, he received an alert on his smartphone that allowed him to take immediate action to protect his bike.",
        "The Lock8 Smart Bike Lock's built-in GPS tracker helped police track down and recover Jane's stolen bike.",
        "Mark was able to share his Lock8 Smart Bike Lock with his friends and family so they could securely lock up their bikes too.",
        "With the Lock8 Smart Bike Lock, Karen never had to worry about forgetting her bike lock combination because she could unlock it with her smartphone.",
        "The Lock8 Smart Bike Lock's advanced tamper detection system alerted Tom of any suspicious activity near his bike.",
    ],
    "Tex-Lock Eyelet Chain Bike Lock": [
        "The Tex-Lock Eyelet Chain Bike Lock's unique textile design made it flexible and easy to transport, without compromising on security.",
        "The Tex-Lock Eyelet Chain Bike Lock's innovative textile construction meant that it was resistant to both cutting and sawing.",
        "Karen was able to lock her bike up to a variety of objects with the Tex-Lock Eyelet Chain Bike Lock's versatile design.",
        "With the Tex-Lock Eyelet Chain Bike Lock's combination lock, Tom didn't have to worry about carrying around a key that could be lost or stolen.",
        "The Tex-Lock Eyelet Chain Bike Lock's lightweight design made it easy for Mark to carry it with him on long rides.",
    ],
    "Abus Bordo Smart 6000A Bike Lock": [
        "The Abus Bordo Smart 6000A Bike Lock's unique folding design made it compact and easy to store, without compromising on security.",
        "Mark was able to use his smartphone to unlock the Abus Bordo Smart 6000A Bike Lock, eliminating the need to carry around keys or remember combinations.",
        "With the Abus Bordo Smart 6000A Bike Lock's integrated alarm system, Karen was alerted whenever someone tried to tamper with her bike.",
        "The Abus Bordo Smart 6000A Bike Lock's durable construction meant that it could withstand even the most determined thieves.",
        "With the Abus Bordo Smart 6000A Bike Lock, Tom could easily secure his bike to a variety of objects thanks to its flexible design.",
    ],
    "Kryptonite Evolution Mini-7 Bike Lock": [
        "Jane's Kryptonite Evolution Mini-7 Bike Lock's hardened steel construction made it virtually impossible for anyone to cut through it with bolt cutters.",
        "With the Kryptonite Evolution Mini-7 Bike Lock's double deadbolt design, Mark felt confident that his bike was secure even in high-crime areas.",
        "Tom was able to easily transport the Kryptonite Evolution Mini-7 Bike Lock thanks to its compact size and lightweight design.",
        "The Kryptonite Evolution Mini-7 Bike Lock's sliding dustcover prevented dirt and debris from jamming the lock mechanism, ensuring smooth operation every time.",
        "With the Kryptonite Evolution Mini-7 Bike Lock's included mounting bracket, Jane could easily attach the lock to her bike frame when not in use.",
    ],
    ...
    "ADT System": [
        "Thanks to ADT System's professional monitoring, Rachel felt secure even when she was away from home.",
    ...
    "Abode Essentials Starter Kit": [
        ...
        "With Abode Essentials Starter Kit's mobile app, Eric could control his Essentials Starter Kit from anywhere.",
    ...
    "Nest Secure Alarm System": [
        ...
        "With Nest Secure Alarm System's mobile app, Jeremy could arm and disarm his security system from anywhere.",
        ...
        "Thanks to Nest Secure Alarm System's built-in Google Assistant, Alex could use voice commands to control his alarm system.",
    ],
    "Swann Security Camera System": [
        "Thanks to Swann Security Camera System's Security Camera System, Kelly could monitor her home from anywhere in the world.",
        "The Swann Security Camera System's motion-activated floodlights scared away a would-be burglar.",
        "With Swann Security Camera System's mobile app, John could view live footage from his security cameras on his phone.",
    ...
    "Frontpoint Home Security System": [
        ...
        "With Frontpoint Home Security System's mobile app, Emily could check in on her home and control her security system from her phone.",
        "The Frontpoint Home Security System's smoke and carbon monoxide detectors saved Dave's family from a dangerous gas leak.",
        "Thanks to Frontpoint Home Security System's 24/7 professional monitoring, Rachel's home was protected even when she wasn't there.",
    ],
    "Scout Alarm System": [
        "Thanks to Scout Alarm System, Sarah was able to feel secure in her home even when she was away.",
        ...
        "With the Scout Alarm System's mobile app, James was able to remotely arm and disarm his security system, making it easy to manage his home security from anywhere.",
    ],
    ...
    "Aqara Water Leak Sensor": [
        "After experiencing a water leak in her basement, Sarah installed an Aqara Water Leak Sensor and can now receive alerts on her phone if any water is detected.",
        "With the Aqara Water Leak Sensor, James can finally have peace of mind knowing that his home is protected from potential water damage.",
        "Thanks to the Aqara Water Leak Sensor, Kelly was able to catch a small leak in her bathroom before it became a big problem.",
        "After hearing about a friend's home flooding, David decided to install Aqara Water Leak Sensors throughout his home to prevent a similar incident.",
        "With the Aqara Water Leak Sensor, John can easily detect if his washing machine is leaking and avoid any water damage to his home.",
    ],
    "SimpliSafe Entry Sensor": [
        "When Maria's SimpliSafe Entry Sensor detected an intruder, it immediately alerted the authorities and helped prevent a break-in.",
        "Thanks to the SimpliSafe Entry Sensor, Tom was able to keep an eye on when his kids arrived home from school.",
        "After a recent break-in, Sophia decided to install SimpliSafe Entry Sensors on all of her windows and doors for added security.",
        "With the SimpliSafe Entry Sensor, Michael can easily monitor when his elderly mother leaves the house and ensure that she is safe.",
        "Thanks to the SimpliSafe Entry Sensor, Rachel can now sleep soundly knowing that her home is protected from potential intruders.",
    ],
    "Google Nest Detect": [
        "After installing Google Nest Detect, Kevin can now receive alerts on his phone if any windows or doors are opened when he's not home.",
        "Thanks to the Google Nest Detect, Emily can easily monitor when her teenage daughter arrives home from school and ensure that she's safe.",
        "With the Google Nest Detect, Mark can easily detect any potential break-ins and notify the authorities immediately.",
        "After experiencing a break-in, Sarah installed Google Nest Detect to give her added peace of mind and protect her home.",
        "Thanks to the Google Nest Detect, Jane can now keep an eye on her vacation home and ensure that it's secure from potential intruders.",
    ],
    "LIFX Tile Motion Sensor": [
        "Thanks to the LIFX Tile Motion Sensor, Rachel can easily automate her home's lighting to turn on when she enters a room.",
        "With the LIFX Tile Motion Sensor, John can easily control his home's lighting without having to get up from the couch.",
        "After installing the LIFX Tile Motion Sensor, Laura can now easily set up a 'movie night' mode that dims the lights when she's watching a movie.",
        "Thanks to the LIFX Tile Motion Sensor, Michael can now easily turn off his bedroom light from the comfort of his bed.",
        "With the LIFX Tile Motion Sensor, Sarah can now easily control her home's lighting with just her voice.",
    ],
    ...
    "Withings ScanWatch": [
        ...
        "Using the Withings ScanWatch Health Mate app, users can easily view their health data and get personalized recommendations for staying healthy.",
    ...
    "Synology RT2600ac": [
        ...
        "Lisa was able to manage and monitor her home network from anywhere using the Synology RT2600ac Router Manager mobile app.",
    ...
    "Samsung QN90A Neo QLED TV": [
        "John was blown away by the amazing picture quality of his Samsung QN90A Neo QLED TV.",
        "Mary enjoyed streaming her favorite movies on her Samsung QN90A Neo QLED TV thanks to its advanced smart features.",
        "Thanks to the sleek design of the Samsung QN90A Neo QLED TV, it perfectly fit into Sarah's living room.",
        "Tom's gaming experience was taken to the next level with his Samsung QN90A Neo QLED TV's 4K resolution and low input lag.",
        "The Samsung QN90A Neo QLED TV's anti-glare screen made it perfect for watching movies during the day without worrying about reflections.",
    ],
    "LG C1 OLED TV": [
        "The LG C1 OLED TV's perfect blacks made the horror movie even scarier for Jane.",
        "David loved the gaming performance of his LG C1 OLED TV.",
        "Samantha was able to mirror her phone screen on her LG C1 OLED TV using its built-in AirPlay 2 feature.",
        "The LG C1 OLED TV's webOS made it easy for Tom to navigate through streaming services.",
        "The LG C1 OLED TV's ultra-thin design made it a perfect fit for Steven's living room.",
    ],
    "Sony Bravia XR A90J OLED TV": [
        "Thanks to the Sony Bravia XR A90J OLED TV's Cognitive Processor XR, Sarah was able to enjoy her favorite movies in stunning detail.",
        "The Sony Bravia XR A90J OLED TV's Acoustic Surface Audio+ technology made it seem like the sound was coming directly from the characters.",
        "The Sony Bravia XR A90J OLED TV's Google TV interface made it easy for John to switch between streaming services.",
        "With the Sony Bravia XR A90J OLED TV's Ambient Optimization technology, the picture and sound adjusted automatically depending on the lighting and acoustics of the room.",
        "Thanks to the Sony Bravia XR A90J OLED TV's HDMI 2.1 ports, Mark was able to enjoy his favorite games with smooth 120Hz refresh rates.",
    ],
    "Vizio M-Series Quantum 4K TV": [
        "The Vizio M-Series Quantum 4K TV's Quantum Color technology made the colors in the movie pop.",
        "Thanks to the Vizio M-Series Quantum 4K TV's SmartCast feature, Sarah was able to easily control her TV using her smartphone.",
        "The Vizio M-Series Quantum 4K TV's 4K resolution and Dolby Vision HDR made Tom's movie experience even more immersive.",
        "Thanks to the Vizio M-Series Quantum 4K TV's V-Gaming Engine, Tim was able to enjoy his favorite games with low input lag and smooth frame rates.",
        "The Vizio M-Series Quantum 4K TV's Full Array backlighting made the picture look even better during dark scenes.",
    ],
    "TCL 6-Series 4K TV": [
    ...
    "Sceptre C248B-144R Gaming Monitor": [
        "Mike was able to immerse himself in his favorite video games like never before with the Sceptre C248B-144R Gaming Monitor's stunning curved display.",
        "Jenny's work productivity skyrocketed after upgrading to the Sceptre C248B-144R Gaming Monitor for its large screen real estate and smooth refresh rate.",
        "The Sceptre C248B-144R Gaming Monitor's sleek design complemented John's gaming setup perfectly, making it the centerpiece of his room.",
        "The Sceptre C248B-144R Gaming Monitor's fast response time and low input lag made it the perfect choice for competitive gamers like Kevin.",
        "Sarah enjoyed watching movies and TV shows on her Sceptre C248B-144R Gaming Monitor thanks to its vibrant colors and deep blacks.",
    ],
    "Insignia 43-Inch 4K UHD Smart Fire TV": [
        "Bob was able to easily access all his favorite streaming services with the built-in Amazon Fire TV on his Insignia 43-Inch 4K UHD Smart Fire TV.",
        "Mary loved the crystal-clear picture quality on her Insignia 43-Inch 4K UHD Smart Fire TV when watching her favorite shows and movies.",
        "The Insignia 43-Inch 4K UHD Smart Fire TV's slim design and voice remote made it easy for Mark to navigate through his content.",
        "The Insignia 43-Inch 4K UHD Smart Fire TV's Dolby Vision HDR and HDR10 enhanced the viewing experience for Lisa, making her feel like she was in the action.",
        "The Insignia 43-Inch 4K UHD Smart Fire TV's compatibility with Alexa allowed for easy voice control of the TV and other smart home devices for David.",
    ],
    "LG InstaView ThinQ": [
    ...
    "Whirlpool Smart French Door": [
        ...
        "Thanks to its smart features, the Whirlpool Smart French Door refrigerator alerted John when he was running low on milk.",
    ...
    "GE Profile Smart Refrigerator": [
        ...
        "Thanks to its smart features, the GE Profile Smart Refrigerator alerted John when he was running low on eggs.",
    ...
    "Haier Smart Refrigerator": [
        ...
        "Thanks to its smart features, the Haier Smart Refrigerator alerted Alex when he was running low on fruits.",
    ...
    "Bosch 800 Series Smart Refrigerator": [
        ...
        "Thanks to its smart features, the Bosch 800 Series Smart Refrigerator alerted Emily when she was running low on vegetables.",
    ...
    "Whirlpool Smart Oven": [
        "After a long day at work, Emily was able to come home and quickly cook a delicious meal in her Whirlpool Smart Oven.",
        "John was able to monitor his Whirlpool Smart Oven from his phone, ensuring that his dinner was cooked perfectly.",
        "The Whirlpool Smart Oven's voice control feature made it easy for Samantha to cook a meal while holding her baby.",
        "Thanks to the Whirlpool Smart Oven's intuitive touchscreen, Mark was able to easily select the perfect cooking settings for his meal.",
        "The Whirlpool Smart Oven's temperature sensor ensured that Ashley's cake was cooked perfectly, with no burnt edges.",
    ],
    "KitchenAid Smart Oven": [
        "The KitchenAid Smart Oven's app made it easy for Lisa to preheat her oven while she was still at the grocery store.",
        "Thanks to the KitchenAid Smart Oven's convection cooking, Michael was able to roast a delicious turkey for his family's holiday dinner.",
        "The KitchenAid Smart Oven's interior light made it easy for David to check on his meal without opening the oven door and releasing heat.",
        "Thanks to the KitchenAid Smart Oven's large cooking capacity, Rachel was able to cook an entire Thanksgiving meal in one oven.",
        "The KitchenAid Smart Oven's self-cleaning feature made it easy for Tom to clean up after his dinner party.",
    ],
    "Sharp Superheated Smart Oven": [
        "The Sharp Superheated Smart Oven's superheated steam made it easy for Sarah to cook a healthy meal without sacrificing flavor.",
        "Thanks to the Sharp Superheated Smart Oven's infrared heating technology, Dan was able to cook a perfectly crisp pizza in just minutes.",
        "The Sharp Superheated Smart Oven's preprogrammed cooking modes made it easy for Karen to cook her favorite dishes with just the touch of a button.",
        "Thanks to the Sharp Superheated Smart Oven's easy-to-use touchscreen, Jake was able to cook a delicious meal without needing to consult a manual.",
        "The Sharp Superheated Smart Oven's compact size made it perfect for apartment living, and allowed Melissa to cook meals without taking up too much space.",
    ],
    "Tovala Smart Oven": [
        "Thanks to the Tovala Smart Oven's meal delivery service, Katie was able to enjoy healthy, chef-prepared meals without having to leave her house.",
        "The Tovala Smart Oven's barcode scanning feature made it easy for James to cook a perfectly prepared meal with no guesswork.",
        "Thanks to the Tovala Smart Oven's broiling feature, Alex was able to make perfectly melted cheese on his nachos.",
        "The Tovala Smart Oven's intuitive app made it easy for Sam to cook a meal while she was working from home.",
        "Thanks to the Tovala Smart Oven's multiple cooking modes, David was able to cook a variety of different meals with ease.",
    ],
    "Miele Smart Oven": [
        "With the Miele Smart Oven, baking the perfect loaf of bread has never been easier!",
        "The Miele Smart Oven's self-cleaning feature saved Lisa so much time and effort.",
        "Using the Miele Smart Oven's intuitive touchscreen controls, Mark was able to cook a gourmet meal for his dinner guests with ease.",
        "The Miele Smart Oven's temperature probe ensures that your meat is cooked to perfection every time.",
        "With the Miele Smart Oven's precise temperature control, baking delicate pastries is a breeze.",
    ],
    "Electrolux Smart Oven": [
        "With the Electrolux Smart Oven, you can control your oven from anywhere with just a few taps on your phone.",
        "Using the Electrolux Smart Oven's pre-programmed cooking modes, Rachel was able to make a perfect roast chicken without any guesswork.",
        "The Electrolux Smart Oven's large interior can easily accommodate even the largest turkey or roast.",
        "With the Electrolux Smart Oven's air fry function, you can enjoy all your favorite fried foods with less oil.",
        "The Electrolux Smart Oven's convection feature ensures even cooking, so your baked goods come out perfectly every time.",
    ],
    "iKettle Wi-Fi Kettle": [
        "With the iKettle Wi-Fi Kettle, you can start boiling water from anywhere using just your phone.",
        "The iKettle Wi-Fi Kettle's temperature control feature lets you choose the perfect temperature for your tea or coffee.",
        "Using the iKettle Wi-Fi Kettle's scheduling feature, you can have hot water ready for you when you wake up in the morning.",
        "The iKettle Wi-Fi Kettle's keep warm feature ensures that your water stays hot for up to 40 minutes.",
        "The iKettle Wi-Fi Kettle's sleek design looks great in any kitchen.",
    ],
    "Smarter iKettle 3.0": [
        "The Smarter iKettle 3.0 can be controlled using your phone, so you can start boiling water without leaving your couch.",
        "With the Smarter iKettle 3.0's wake up mode, you can have hot water ready for you when you get up in the morning.",
        "Using the Smarter iKettle 3.0's custom temperature control feature, you can choose the perfect temperature for your tea or coffee.",
        "The Smarter iKettle 3.0's keep warm feature ensures that your water stays hot for up to 30 minutes.",
        "The Smarter iKettle 3.0's elegant design will make a stylish addition to any kitchen.",
    ],
    "Breville Smart Kettle": [
        "John was able to boil water without even entering the kitchen, thanks to the Breville Smart Kettle's Wi-Fi connectivity and voice control feature.",
        "Anna loved the Breville Smart Kettle's ability to maintain a specific temperature for different types of tea.",
        "The Breville Smart Kettle's mobile app allowed Emily to control the kettle from her phone and set it to boil water as soon as she got home.",
        "Mark enjoyed the Breville Smart Kettle's keep-warm feature, which kept his tea at the perfect temperature for hours.",
        "The Breville Smart Kettle's LED lights changed color as the water boiled, making the boiling process more enjoyable for Alice.",
    ],
    "Smeg KLF04 Smart Kettle": [
        "Thanks to the Smeg KLF04 Smart Kettle's app, Sophie could control the kettle from anywhere in the house.",
        "The Smeg KLF04 Smart Kettle's retro design perfectly complemented Max's vintage-inspired kitchen.",
        "Oliver loved the Smeg KLF04 Smart Kettle's ability to maintain a specific temperature for different types of coffee.",
        "The Smeg KLF04 Smart Kettle's keep-warm feature kept Lily's tea at the perfect temperature while she worked.",
        "The Smeg KLF04 Smart Kettle's soft-opening lid mechanism made pouring water a breeze for Ben.",
    ],
    "Tefal Smart Kettle": [
        "Thanks to the Tefal Smart Kettle's mobile app, John could set the kettle to boil water as soon as he got home.",
        "The Tefal Smart Kettle's keep-warm feature kept Sarah's tea at the perfect temperature for hours.",
        "The Tefal Smart Kettle's stainless steel design matched perfectly with Tom's modern kitchen.",
        "The Tefal Smart Kettle's ability to maintain a specific temperature for different types of tea impressed Rachel.",
        "The Tefal Smart Kettle's rapid-boil feature allowed Harry to make a cup of coffee in no time.",
    ],
    "Hamilton Beach Smart Kettle": [
        "Thanks to the Hamilton Beach Smart Kettle's Alexa integration, Sarah could ask Alexa to boil water for her tea.",
        "The Hamilton Beach Smart Kettle's keep-warm feature kept John's coffee at the perfect temperature for hours.",
        "The Hamilton Beach Smart Kettle's 360-degree rotating base made it easy for Alice to pick up the kettle from any angle.",
        "The Hamilton Beach Smart Kettle's stainless steel finish added a touch of elegance to Emily's kitchen.",
        "The Hamilton Beach Smart Kettle's safety feature automatically turned the kettle off once the water boiled, giving Tom peace of mind.",
    ],
    ...
    "Behmor Connected Coffee Maker": [
        ...
        "By connecting his Behmor Connected Coffee Maker to Alexa, Tom was able to start brewing coffee without even getting out of bed.",
    ...
    "Breville Smart Coffee Maker": [
        ...
        "By connecting his Breville Smart Coffee Maker to his smart home system, Mike was able to control the brewing process with his voice.",
    ...
    "Keurig K-Elite Single Serve Coffee Maker": [
        ...
        "By using the Keurig K-Elite Single Serve Coffee Maker's iced coffee setting, Mike was able to enjoy a refreshing iced coffee on a hot summer day.",
        "The Keurig K-Elite Single Serve Coffee Maker's large water reservoir made it easy for Jane to brew multiple cups of coffee without refilling.",
        "With the Keurig K-Elite Single Serve Coffee Maker, Sarah was able to brew a cup of coffee directly into her travel mug, saving her time in the morning.",
    ],
    ...
    "Mr. Coffee Smart Coffee Maker": [
        ...
        "Thanks to Mr. Coffee Smart Coffee Maker's compatibility with Google Assistant, Jason can start brewing coffee with just his voice.",
    ...
    "Dyson Pure Cool Tower Fan": [
        "Mark was able to remotely control the fan speed and air purification of his Dyson Pure Cool Tower Fan using his smartphone.",
        "The Dyson Pure Cool Tower Fan's HEPA filter helped reduce the allergens in Sarah's home, making it easier for her to breathe.",
        "Thanks to its quiet operation, the Dyson Pure Cool Tower Fan was able to keep John's bedroom cool and comfortable without disturbing his sleep.",
        "The Dyson Pure Cool Tower Fan was able to automatically monitor and purify the air in Amanda's home, giving her peace of mind about the air quality.",
        "David was able to schedule the Dyson Pure Cool Tower Fan to turn on automatically, ensuring that his home was cool and comfortable when he arrived.",
    ],
    "Haiku Smart Ceiling Fan": [
        "Thanks to its smart integration with Alexa, Jessica was able to control her Haiku Smart Ceiling Fan using voice commands.",
        "The Haiku Smart Ceiling Fan's energy-efficient design helped reduce the energy costs in Tom's home.",
        "The Haiku Smart Ceiling Fan's built-in motion sensors were able to automatically adjust the fan speed based on the temperature and occupancy in the room.",
        "With its sleek design and smart features, the Haiku Smart Ceiling Fan was the perfect addition to Sarah's modern living room.",
        "The Haiku Smart Ceiling Fan's mobile app allowed Michael to control the fan speed and lighting from anywhere.",
    ],
    "Modern Forms Smart Fan": [
        "The Modern Forms Smart Fan's weather-resistant design made it the perfect addition to John's outdoor patio.",
        "Thanks to its energy-efficient DC motor, the Modern Forms Smart Fan was able to keep Elizabeth's home cool without driving up her energy bills.",
        "The Modern Forms Smart Fan's integrated LED lighting provided a warm and inviting atmosphere in David's home.",
        "Thanks to its smart integration with Nest, the Modern Forms Smart Fan was able to automatically adjust the fan speed based on the temperature in the room.",
        "The Modern Forms Smart Fan's mobile app allowed Sarah to control the fan speed and lighting from her smartphone.",
    ],
    "Hunter Apache Smart Ceiling Fan": [
        "Thanks to its whisper-quiet operation, the Hunter Apache Smart Ceiling Fan was able to keep Michael's bedroom cool and comfortable without disturbing his sleep.",
        "The Hunter Apache Smart Ceiling Fan's built-in Wi-Fi allowed Sarah to control the fan speed and lighting using her smartphone.",
        "Thanks to its energy-efficient design, the Hunter Apache Smart Ceiling Fan was able to reduce the energy costs in David's home.",
        "The Hunter Apache Smart Ceiling Fan's integrated LED lighting provided a warm and inviting atmosphere in Elizabeth's home.",
        "With its stylish design and smart features, the Hunter Apache Smart Ceiling Fan was the perfect addition to Jessica's living room.",
    ],
    "Dyson Pure Cool Tower Fan": [
        "Mark was able to remotely control the fan speed and air purification of his Dyson Pure Cool Tower Fan using his smartphone.",
        "The Dyson Pure Cool Tower Fan's HEPA filter helped reduce the allergens in Sarah's home, making it easier for her to breathe.",
    ...
    "Smart Dehumidifier": [
        "With Smart Dehumidifier, Tom's entire house was free of excess moisture and mildew.",
        "Thanks to Smart Dehumidifier's automatic humidistat control, Rachel's basement stayed at the perfect humidity level.",
        "Smart Dehumidifier's defrost function prevented ice from forming on the coils in Sarah's garage.",
        "The Smart Dehumidifier's large tank capacity meant that David didn't have to empty it as often.",
        "Smart Dehumidifier's built-in pump allowed Chris to drain the water directly into a sink or drain.",
    ],
...
def returnSentencesFormated():
    result = []
    for k in sentences.keys():
        for sentence in sentences[k]:
            s = {"type": "Device", "word": k, "phrase": sentence}
            result.append(s)
    return result
...
if __name__ == "__main__":
    ...
    for val in returnSentencesFormated():
        print(val)
        break
    with open("./_6_sentences_formatted.py", "w") as f:
        f.write("sentences_formatted = ")
        f.write(f"{returnSentencesFormated()}")
